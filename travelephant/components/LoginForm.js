        ...
        <div className='bg-white flex flex-col items-center p-4 space-y-8 w-full md:w-1/2'>
          ...
          <form className='flex flex-col items-center p-4'>
            <div className='relative'>
              ...
              <input className='border border-gray-300 outline-none placeholder-gray-400 pl-9 pr-4 py-1 rounded-md transition focus:ring-2 focus:ring-indigo-600' placeholder='Username' type='text'/>
            </div>
            <div className='relative'>
              <span className='absolute flex inset-y-0 items-center pl-3 text-gray-400'><FaLock /></span>
              <input className='border border-gray-300 outline-none placeholder-gray-400 pl-9 pr-4 py-1 rounded-md transition focus:ring-2 focus:ring-indigo-600' placeholder='Password' type='password'/>
            </div>
